...
-(void)setCategory:(Category *)category{
    ...
    for (NSInteger i=0; i<row; i++) {
        RecipeView *recipeView1=[[RecipeView alloc] initWithFrame:CGRectMake(40, i*220+10, 200, 200)];
        Recipe *recipe1=[_category.allRecipes objectAtIndex:3*i];
        recipeView1.recipe=recipe1;
        [self addSubview:recipeView1];
        [recipeView1 release];
        
        RecipeView *recipeView2=[[RecipeView alloc] initWithFrame:CGRectMake(280, i*220+10, 200, 200)];
        Recipe *recipe2=[_category.allRecipes objectAtIndex:3*i+1];
        recipeView2.recipe=recipe2;
        [self addSubview:recipeView2];
        [recipeView2 release];
        
        RecipeView *recipeView3=[[RecipeView alloc] initWithFrame:CGRectMake(520, i*220+10, 200, 200)];
    ...
    for (NSInteger i=0; i<lastRowCount; i++) {
        RecipeView *recipeView=[[RecipeView alloc] initWithFrame:CGRectMake(40*(i+1)+200*i, row*220+10, 200, 200)];
